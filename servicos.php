<?php include_once 'includes/servicos_insert.php' ?>
...
<br><br>
	<div class="login-logo">
		<a href="#">Servicos e Referencias ao Outros Servicos Sociais</a>
	</div>
...
<div class="col-md-2">
	<h4 class="A">N=Serviço Recebido</h4>
	<br>
	<h4 class="A">R=Referido para outro Sitio</h4>
</div>
    ...
    <table class='table borderless'>
      ...
      <tr>
          <td style="border-top: none;">Codigo de Benificiario:</td>
       ...
       $crud->dataview_servicos_verify($newquery);
      ?>
</table>
</div>
