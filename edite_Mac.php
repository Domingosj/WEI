...
if(isset($_POST['btn-update']))
{
  ...
  if($crud->update_mac($id,$nome,$idade,$cd_ident,$nome_cuidador,$sexo,$provincia,$nome_voluntario,$nome_lider,$nome_ocb,$destrito,$hiv,$tarv,$situacao_crianca,
...
<?php include_once 'includes/edite_form_mac.php';?>
