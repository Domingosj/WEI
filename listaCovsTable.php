        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">  Tabela de lista de Cov's</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              ...
              <tbody>
					...
					$query = "SELECT * FROM lista_covs";
							 $records_per_page= $crud->getBenCount();
							 $newquery = $crud->paging($query,$records_per_page);
						$crud->dataview_ListaCovs($newquery);
										...
										$query = "SELECT * FROM lista_covs WHERE nomeOCB = '$ocb' ";
											 $records_per_page= $crud->getBenCount();
											 $newquery = $crud->paging($query,$records_per_page);
											 $crud->dataview_ListaCovsDG($newquery);
