...
<head>
  ...
  <title>Bantwana DataServ - Lista de beneficiarios com criterios de graduação</title>
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h4 class="box-title"> Lista de beneficiarios com criterios de graduação</h4>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
									...
									if ($nivel==1 || $nivel==2 ) {
			 						 ...
			 						 $crud->dataview_val12($newquery,$nivel,$ocb);
