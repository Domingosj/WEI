...
<head>
  ...
  <title>Bantwana DataServ - Lista de beneficiarios que nao tem o seu MAC preenchido</title>
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h4 class="box-title"> Lista de beneficiarios que nao tem o seu MAC preenchido</h4>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
									...
									if ($nivel==1 || $nivel==2 ) {
	 								 ...
	 								 $crud->dataview_val9B($newquery,$nivel,$ocb);
