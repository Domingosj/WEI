...
<head>
  ...
  <title>Bantwana DataServ - Lista de beniciarios que receberam 3 serviço</title>
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">  Lista de beniciarios que receberam 3 serviço</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
	                 ...
	                 $crud->Data_serv3($newquery,$ocb,$nivel);
