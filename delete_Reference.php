...
{
	$id = $_GET['delete_id'];
	$crud->delete_reference($id);
	header("Location: delete_Reference.php?deleted");
}
...
if(isset($_GET['delete_id']))
{
	?>
			...
			<?php
			$stmt = $DB_con->prepare("SELECT * FROM gestao_crcr WHERE reference_id=:id");
...
?>
 <form method="post">
 <input type="hidden" name="id" value="<?php echo $row['reference_id']; ?>" />
