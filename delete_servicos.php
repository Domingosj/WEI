...
{
	$id = $_GET['delete_id'];
	$crud->delete_servicos($id);
	header("Location: delete_servicos.php?deleted");
}
...
if(isset($_GET['delete_id']))
{
	?>
			...
			<?php
			$stmt = $DB_con->prepare("SELECT * FROM servicos_bross WHERE servicosBross_id=:id");
...
?>
 ...
 <a href="servicos_table.php" class="btn btn-large btn-success"><i class="glyphicon glyphicon-backward"></i> &nbsp; NAO</a>
 </form>
<?php
}
else
